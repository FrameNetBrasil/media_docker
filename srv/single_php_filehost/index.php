...
class CONFIG
{
    ...
    const MIN_FILEAGE = 10; //min. age of files in days
    const DECAY_EXP = 2; //high values penalise larger files more

    const UPLOAD_TIMEOUT = 300; //max. time an upload can take before it times out
    ...
    const LOG_PATH = '/log/log.txt'; //path to log uploads + resulting links to
